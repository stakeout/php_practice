...
<div class="reviews">
    ...
    <form class="reviews-form" action="#" method="POST">
        ...
        <label for="message">
            ...
            <textarea class="<?php echo(isset($error['message']) ? 'error' : null) ?>" name="message" id="message" placeholder="напишите нам что-нибудь" rows="10"><?php echo htmlspecialchars(isset($_POST['message']) ? $_POST['message'] : null);?></textarea>
        </label>
